...
return [
    ...
    'info' => [
         ...
         */
        'description' => 'Umrany platform API — see docs/api/conventions.md for auth, envelope shapes, and rate limits.',
    ],
     ...
     * ],
     */
    // Derives OpenAPI `security` from each route's auth:sanctum middleware — replaces the 24
    // hand-written @authenticated Scribe tags. See docs/decisions/0023-scramble-over-scribe.md.
